...
@WebFilter(filterName = "UserLoginFilter", urlPatterns = {"/*"}, initParams = {
        @WebInitParam(name = "avoid-urls", value = "/login,/login/,/adminpanel/*") // na tych adresach nie chce sprawdzac logowania, bo mi sie zapetli redirect!
})
